				...
				<div className="flex-container">
					<div className="row justify-content-center">
						<div className="col-md-6 col-lg-4 col-xl-3">
							<div
								id="main3"
								className="card  h-100 w-75"
								style={{ backgroundColor: "#024752", textAlign: "center" }}>
								<div className="card-body mt-2">
									<h5 className="card-title" style={{ color: "white" }}>
										GREAT FREE MOVIES
									</h5>
									<ul className="striped mb-0" style={{ color: "white" }}>
										<li>
											<p>
												Grover constantly searching all over the web for the best torrents from
								...
								<div className="card-footer " style={{ borderTop: "none", backgroundColor: "#024752" }}>
									<button
										id="btnhover"
										type="button"
										className="w3-button w3-round-xlarge"
										style={{ backgroundColor: "#024752", color: "white" }}>
										SUBCRIBE
									</button>
								</div>
							</div>
							...
							<div
								...
								<div className="card-body mt-2">
									...
									<ul className="striped mb-0" style={{ color: "white" }}>
										...
										<li>
											<p>
												Watch any movie or TV show as many times as you want. All you need to
												get started is a proper internet connection
											</p>
										</li>
										<li>
							...
							<div
								...
								<div className="card-body mt-2">
									...
									<ul className="striped mb-0" style={{ color: "white" }}>
										<li>
											<p>
												Watch your movie or episode instantly in HD and with subtitles. And then
												keep watching.
											</p>
										</li>
										<li>
										...
										<li>
											<p>
												No wait or download time. Instant playback of your favorite free movies
												and TV shows.
											</p>
										</li>
										<li>
